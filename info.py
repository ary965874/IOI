...
BOT_TOKEN = environ.get('BOT_TOKEN', "7610200234:AAE9OqwCpLNHoC1G3Wh2YSSUnSzwNRBgVB0")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/5250452a1ab5364cfc4dc.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7907742294').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AX_FILMZ')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AX_FILMZ')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AX_FILMZ')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "False")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>{file_caption}</b> \n\n<b>ᴊᴏɪɴ ɴᴏᴡ: [Our Channel](https://t.me/AX_FILMZ)</b>\n<b>Instagram: [Subscribe](https://www.instagram.com/AX_FILMZ/)</b>")
